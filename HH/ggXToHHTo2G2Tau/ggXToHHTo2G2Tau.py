...
dict_ranges  = {
    "Radion"       : ["1000", "1100", "1200", "1300", "1400", "1500", "1600", "1700", "1800", "1900", "2000", "2200", "2400", "2600", "2800", "3000"],
    "BulkGraviton" : ["1000", "1250", "1500", "1750", "2000", "2500", "3000"]
}
...
t_datasetname = "GluGluTo<RESTYPE>ToHHTo2G2Tau_M-<RANGE>_TuneCP5_PSWeights_narrow_13TeV-madgraph-pythia8"
    ...
    for res in resType:
        with open(res+'_'+year+'.csv', 'w') as csvfile:
            ...
            for r in dict_ranges[res]:
                ...
                if 0: print("[%s] Dataset name: %s" % (res,dataset_name))
