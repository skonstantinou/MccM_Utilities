...
def GetRange(filaname):
    ...
    for i,l in enumerate(lines):
        ...
        _range = _range.replace("/eos/cms/store/group/phys_higgs/HiggsExo/kjaffel/HToZATo2L2B_ggfusion_b-associatedproduction/waiting_for_submission_to_mcm/bbH/AToZHTo2L2B_", "")
...
ranges = GetRange("notSubmitted_bbH_AtoZH.txt")
...
dataset_names = {}
version="2.6.5"
#t_datasetname = "AToZHTo2L2B_<RANGE>_TuneCP5_bbH4F_13TeV-mcatnlo-pythia8" # NLO
t_datasetname = "AToZHTo2L2B_<RANGE>_TuneCP5_bbH4F_13TeV-madgraph-pythia8"
# priority
...
#t_gp = "/eos/cms/store/group/phys_higgs/HiggsExo/kjaffel/HToZATo2L2B_ggfusion_b-associatedproduction/waiting_for_submission_to_mcm/bbH/AToZHTo2L2B_<RANGE>_bbH4F_TuneCP5_13TeV_pythia8_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz"
t_gp = "/cvmfs/cms.cern.ch/phys_generator/gridpacks/UL/13TeV/madgraph/V5_2.6.5/AToZHTo2L2B_<RANGE>_bbH4F_TuneCP5_13TeV_pythia8/v1/AToZHTo2L2B_<RANGE>_bbH4F_TuneCP5_13TeV_pythia8_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz"
...
for i, year in enumerate(years):
    with open('AToZHTo2L2B_bbH4F_'+year+'.csv', 'w') as csvfile:
        ...
        for r in ranges:
            ...
            rangeList = r.split("_") 
            rangeType = "MA-%s_MH-%s_tb-%s" % (rangeList[0], rangeList[1], rangeList[2])
